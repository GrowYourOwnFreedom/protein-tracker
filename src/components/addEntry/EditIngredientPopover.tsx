...
function EditIngredientPopover( {selectedIngredient, onClick, onEditIngredient}:EditIngredientPopoverProps) {
  ...
  <PopoverTrigger onClick={handlePopoverClick} asChild>
    <Button className="w-fit mx-auto rounded-full" variant="outline">Edit Ingredient</Button>
  </PopoverTrigger>
  <PopoverContent align="end">
    ...
    <IngredientDetailsForm existingIngredient={selectedIngredient} onEditIngredient={handleEditIngredient}/>
  </PopoverContent>
</Popover>
    )
}
